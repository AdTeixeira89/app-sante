...
## Funcionalidades (etapa 1 — protótipo)

- Adicionar consultas: médico, motivo, data, hora, local, foto do documento associado (convocatória, receita...)
- Biblioteca de documentos (todas as fotos anexadas às consultas, organizadas por data)
